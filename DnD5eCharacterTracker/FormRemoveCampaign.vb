Public Class FormRemoveCampaign
...
#Region " Form And Control Procedures "
    ...
    Private Sub FormRemoveCampaign_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            AddHandler Me.ButtonCampaignCancel.Click, AddressOf CloseForm
            AddHandler Me.ButtonCampaignRemove.Click, AddressOf RemoveCampaign
...
#Region " Common Form Procedures "
    ...
    Private Sub FormatControls()
        ...
        '[ Me ]
        With Me
            .Text = System.String.Format("{0}", "Remove Campaign")
        ...
        '[ ButtonCampaignLoad ]
        With Me.ButtonCampaignRemove
            .Text = System.String.Format("{0}", "Remove")
            .BackColor = System.Drawing.Color.White
            .Cursor = System.Windows.Forms.Cursors.Default
            .FlatStyle = System.Windows.Forms.FlatStyle.System
            .Font = New System.Drawing.Font(SetFontFamily("Segoe UI", "Microsoft Sans Serif"), 9.75, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point)
    ...
    Private Sub RemoveCampaign()
        ...
        Try
            If Me.ListViewCampaigns.SelectedItems.Count > 0 Then
                _DialogResult = MessageBox.Show(System.String.Format("Are you sure you want to remove the campaign '{0}'? Characters in this campaign will also be removed.", Me.ListViewCampaigns.SelectedItems(0).SubItems(1).Text.ToString), "Character Tracker Says ...", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
                If _DialogResult = System.Windows.Forms.DialogResult.Yes Then
                    ...
                    If _Campaign IsNot Nothing Then _Campaign = Nothing
                        ...
                        If _SQLiteConnect.State = System.Data.ConnectionState.Open Then
                            Using _SQLiteConnect
                                ...
                                With _SQLiteCommand
                                    ...
                                    .Parameters.AddWithValue("@id", _SelectedCampaign)
                                ...
                                With _QueryString
                                    .Clear()
                                    .Append("DELETE FROM campaigns WHERE id=@id")
                                End With
                                _SQLiteCommand = New System.Data.SQLite.SQLiteCommand(_QueryString.ToString(), _SQLiteConnect)
                                With _SQLiteCommand
                                    '[ Add Parameter Values. ]
            ...
            If _SQLiteConnect IsNot Nothing Then
                If _SQLiteConnect.State = System.Data.ConnectionState.Open Then
                    Using _SQLiteConnect
                        With _QueryString
                            .Clear()
                            .Append("SELECT id, name, gamemaster FROM campaigns ORDER BY datemodified DESC;")
                        End With
                        _SQLiteCommand = New System.Data.SQLite.SQLiteCommand(_QueryString.ToString(), _SQLiteConnect)
                        With _SQLiteCommand
